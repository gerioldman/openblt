/************************************************************************************//**
* \file         Source/CH32V307/GCC/cpu_comp.c
* \brief        Bootloader cpu module source file.
* \ingroup      Target_CH32V307_cpu_comp
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
/************************************************************************************//**
* \defgroup   Target_CH32V307_cpu_comp Compiler specifics of a port
* \brief      This module implements the compiler specific parts of a microcontroller
*             port.
* \ingroup    Target_CH32V307
****************************************************************************************/
